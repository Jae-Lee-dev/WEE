...
- Run `pnpm verify` before handing off app/runtime changes; in the current Figma-first phase it covers the phase-scope guardrail self-test, phase-scope audit, lint, typecheck, and production build.
