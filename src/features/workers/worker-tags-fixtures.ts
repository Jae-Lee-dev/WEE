...
export const workerTagEditDialog = {
  ...
  workers: [
    { id: "worker-kim-seoyeon", name: "김서연", checked: true, disabled: false },
    { id: "worker-lee-minjun", name: "이민준", checked: true, disabled: false },
    { id: "worker-choi-hayoung", name: "최하영", checked: true, disabled: true },
    { id: "worker-jeong-daeun", name: "정다은", checked: true, disabled: false },
    { id: "worker-baek-seunghyun", name: "백승현", checked: true, disabled: true },
