...
} from "../api/dashboard-summary-data-source";
import {
        ...
        <Button
          ...
          onClick={() =>
            downloadCsv(
              ...
              createLocationExportRows({
                locationLabel: getOptionLabel(viewModel.locationOptions, locationId),
                periodLabel,
                rows,
              }),
            )
...
function createLocationExportRows({
  locationLabel,
  periodLabel,
  rows,
}: {
